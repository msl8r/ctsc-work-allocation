...
public class CcdConnectorService {
    ...
    private static final String PROBATE_GOP_QUERY = DATE_RANGE
        ...
        + "{\"match\":{\"data.caseType\":\"gop\"}},{\"match\":{\"data.registryLocation\":\"ctsc\"}}]}},"
        + "{\"bool\":{\"must\":[{\"match\":{\"state\":\"BOCaseStopped\"}},"
        + "{\"match\":{\"data.applicationType\":\"Personal\"}},{\"match\":{\"data.caseType\":\"intestacy\"}},"
        + "{\"match\":{\"data.evidenceHandled\":\"No\"}},{\"match\":{\"data.registryLocation\":\"ctsc\"}}]}},"
        + "{\"bool\":{\"must\":[{\"match\":{\"state\":\"BOCaseStopped\"}},"
        + "{\"match\":{\"data.applicationType\":\"Solicitor\"}},{\"match\":{\"data.solsWillType\":\"NoWill\"}},"
        + "{\"match\":{\"data.evidenceHandled\":\"No\"}},{\"match\":{\"data.registryLocation\":\"ctsc\"}}]}},"
        + "{\"bool\":{\"must\":[{\"match\":{\"state\":\"BOCaseStopped\"}},"
        + "{\"match\":{\"data.applicationType\":\"Personal\"}},{\"match\":{\"data.evidenceHandled\":\"Yes\"}},"
        + "{\"match\":{\"data.caseType\":\"gop\"}},{\"match\":{\"data.registryLocation\":\"ctsc\"}}]}},"
        + "{\"bool\":{\"must\":[{\"match\":{\"state\":\"BOCaseStopped\"}},"
        + "{\"match\":{\"data.applicationType\":\"Solicitor\"}},{\"match\":{\"data.evidenceHandled\":\"Yes\"}},"
        + "{\"match\":{\"data.caseType\":\"gop\"}},{\"match\":{\"data.registryLocation\":\"ctsc\"}}]}},"
        + "{\"bool\":{\"must\":[{\"match\":{\"state\":\"BOCaseStopped\"}},"
        + "{\"match\":{\"data.applicationType\":\"Personal\"}},{\"match\":{\"data.caseType\":\"intestacy\"}},"
        + "{\"match\":{\"data.evidenceHandled\":\"Yes\"}},{\"match\":{\"data.registryLocation\":\"ctsc\"}}]}},"
        + "{\"bool\":{\"must\":[{\"match\":{\"state\":\"BOCaseStopped\"}},"
        + "{\"match\":{\"data.applicationType\":\"Solicitor\"}},{\"match\":{\"data.solsWillType\":\"NoWill\"}},"
        + "{\"match\":{\"data.evidenceHandled\":\"Yes\"}},"
        + "{\"match\":{\"data.registryLocation\":\"ctsc\"}}]}}]}}]}},"
        + "\"_source\":[\"reference\",\"jurisdiction\",\"state\",\"last_modified\",\"data.applicationType\","
        + "\"data.evidenceHandled\",\"data.caseType\",\"data.registryLocation\",\"data.solsWillType\"],\"size\":1000}";
